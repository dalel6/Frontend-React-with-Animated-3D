    ...
    <><div className='title'>
          <ThirdTitle />
              ...
              <div className="text-column">
                  <h1 className="h1-separator">1- WHAT IS A VR CAVE?</h1>
                  <p>
                      {showMore.p1 ? (
                  ...
                  <h1 className="h1-separator">2- HOW DOES A VR CAVE WORK?</h1>
                  <p>
                      {showMore.p2 ? (
                  ...
                  <h1 className="h1-separator">3- WHY ARE VR CAVES SO IMPORTANT?</h1>
                  <p>
                      {showMore.p3 ? (
