...
const cardsData = [
	...
	},
	{
		...
		description:
			"Embedding tools for hosting virtual events and conferences directly on their website, where attendees can navigate a virtual space, interact with others, attend talks or presentations, and engage with interactive booths.",
	},
	{
		id: 5,
		image: "./education.png",
		...
		description:
			"Companies can offer immersive educational experiences or training modules using VR/AR, where employees or customers can learn about products or skills in an engaging, hands-on virtual environment.",
	},
	{
		id: 6,
		image: "./avatar1.png",
