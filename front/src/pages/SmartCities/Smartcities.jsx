			...
			<div className="products">
				<div className="product">
					...
					<div className="text" style={{ position: "relative", marginLeft: "10%", color: "black" }}>
						...
						<p>
							...
							<br /> <br />
							Edge AI provides advanced solutions for data processing and analytics.
							<br />
							<br />
				...
				<div className="product">
					<div className="text" style={{ position: "relative", marginLeft: "10%" }}>
						...
						<p>
							...
							<br />
							<br />
							Edge AI caters to the needs of IoT and industrial applications.
							<br />
							<br />
							Their solutions are known for reliability and versatility,
							<br />
				...
				<div className="product">
					...
					<div className="text" style={{ position: "relative", marginLeft: "10%" }}>
						...
						<p>
							{" "}
							Edge AI excels in providing professional visualization solutions, <br />
							<br /> including high-performance graphics cards and visualization software. <br />
							<br /> These solutions are ideal for graphics-intensive applications
							<br />
							<br />
							in design, visualization, and digital content creation.
						</p>
					</div>
				</div>
				<div className="product">
				...
				<div className="product">
					...
					<div className="text" style={{ position: "relative", marginLeft: "10%" }}>
						...
						<p>
							...
							<br />
							<br /> These products ensure robust and secure connectivity for various network
							infrastructures.
						</p>
					</div>
				</div>
				<div className="product">
					<div className="text" style={{ position: "relative", marginLeft: "10%" }}>
						...
						<p>
							...
							<br />
							<br />
							to handle complex computations and large datasets efficiently.
						</p>
					</div>
				...
				<div className="product">
					...
					<div className="text" style={{ position: "relative", marginLeft: "10%" }}>
						...
						<p>
							{" "}
							In addition to their primary offerings, Edge AI also provides a variety of accessories and
							components,
							<br />
							<br />
							including cables, adapters, and power supplies,
							<br />
