			...
			<div className="products">
				...
				<div className="product3">
					...
					<div className="text" style={{ position: "relative", marginLeft: "10%" }}>
						...
						<p>
							{" "}
							Our web design and development services are focused <br />
							<br /> on creating visually stunning and interactive websites.
							<br />
							<br /> We ensure that our websites are not only aesthetically pleasing <br />
							<br />
							but also highly functional, responsive, and user-friendly, catering to a global audience.
						</p>
					</div>
				</div>
				<div className="product2">
				...
				<div className="product3">
					...
					<div className="text" style={{ position: "relative", marginLeft: "10%" }}>
						...
						<p>
							Our graphic design services encompass everything from logo design to full brand identity
							development.
							<br />
							<br />
